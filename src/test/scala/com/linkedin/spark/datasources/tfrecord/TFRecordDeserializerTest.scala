...
class TFRecordDeserializerTest extends WordSpecLike with Matchers {
  ...
  val longFeature = Feature
    .newBuilder()
    .setInt64List(Int64List.newBuilder().addValue(23L))
    .build()
  val floatFeature = Feature
    .newBuilder()
    .setFloatList(FloatList.newBuilder().addValue(10.0F))
    .build()
  val doubleFeature = Feature
    .newBuilder()
    .setFloatList(FloatList.newBuilder().addValue(14.0F))
    .build()
  val decimalFeature = Feature
    .newBuilder()
    .setFloatList(FloatList.newBuilder().addValue(2.5F))
    .build()
  val longArrFeature = Feature
    .newBuilder()
    .setInt64List(Int64List.newBuilder().addValue(-2L).addValue(7L).build())
    .build()
  val doubleArrFeature = Feature
    .newBuilder()
    .setFloatList(FloatList.newBuilder().addValue(1F).addValue(2F).build())
    .build()
  val decimalArrFeature = Feature
    .newBuilder()
    .setFloatList(FloatList.newBuilder().addValue(3F).addValue(5F).build())
    .build()
  val strFeature = Feature
    .newBuilder()
    .setBytesList(
      BytesList
        .newBuilder()
        .addValue(ByteString.copyFrom("r1".getBytes))
        .build()
    )
    .build()
  val strListFeature = Feature
    .newBuilder()
    .setBytesList(
      BytesList
        .newBuilder()
        .addValue(ByteString.copyFrom("r2".getBytes))
        .addValue(ByteString.copyFrom("r3".getBytes))
        .build()
    )
    .build()
  val binaryFeature = Feature
    .newBuilder()
    .setBytesList(
      BytesList.newBuilder().addValue(ByteString.copyFrom("r4".getBytes))
    )
    .build()
  val binaryListFeature = Feature
    .newBuilder()
    .setBytesList(
      BytesList
        .newBuilder()
        .addValue(ByteString.copyFrom("r5".getBytes))
        .addValue(ByteString.copyFrom("r6".getBytes))
        .build()
    )
    .build()
  ...
  "Deserialize tfrecord to spark internalRow" should {
    ...
    "Serialize spark internalRow to tfrecord sequenceExample" in {
      ...
      val int64FeatureList =
        FeatureList.newBuilder().addFeature(longArrFeature).build()
      val floatFeatureList = FeatureList
        .newBuilder()
        .addFeature(floatFeature)
        .addFeature(doubleArrFeature)
        .build()
      val decimalFeatureList =
        FeatureList.newBuilder().addFeature(decimalArrFeature).build()
      val stringFeatureList = FeatureList
        .newBuilder()
        .addFeature(strListFeature)
        .addFeature(strFeature)
        .build()
      val binaryFeatureList = FeatureList
        .newBuilder()
        .addFeature(binaryListFeature)
        .addFeature(binaryFeature)
        .build()
      ...
      val seqExample = SequenceExample
        .newBuilder()
        .setContext(features)
    ...
    "Throw an exception for unsupported data types" in {
      ...
      val int64FeatureList =
        FeatureList.newBuilder().addFeature(longArrFeature).build()
      val featureLists =
        FeatureLists.newBuilder().putFeatureList("MapLabel2", int64FeatureList)
    ...
    "Throw an exception for non-nullable data types" in {
      val features =
        Features.newBuilder().putFeature("FloatLabel", floatFeature)
      val int64FeatureList =
        FeatureList.newBuilder().addFeature(longArrFeature).build()
      val featureLists = FeatureLists
        .newBuilder()
      ...
      intercept[NullPointerException] {
        val example = Example
          ...
          .build()
        val schema = StructType(
          List(StructField("MissingLabel", FloatType, nullable = false))
        )
        val deserializer = new TFRecordDeserializer(schema)
        deserializer.deserializeExample(example)
      }
    ...
    "Return null fields for nullable data types" in {
      ...
      val expectedInternalRow1 = InternalRow.fromSeq(Array[Any](10.0F, null))
      val example = Example
        .newBuilder()
        .setFeatures(features)
        .build()
      ...
      val expectedInternalRow2 =
        InternalRow.fromSeq(Array[Any](createArray(createArray(-2L, 7L)), null))
      val seqExample = SequenceExample
        .newBuilder()
        .setContext(features)
        .setFeatureLists(featureLists)
      ...
      val actualInternalRow2 =
        deserializer2.deserializeSequenceExample(seqExample)
      assert(actualInternalRow2 ~== (expectedInternalRow2, schema2))

    }

    val schema = StructType(Array(StructField("LongLabel", LongType)))
    val deserializer = new TFRecordDeserializer(schema)
    ...
    "Test bytesListFeature2SeqArrayByte" in {
      val bytesList = BytesList
        .newBuilder()
        .addValue(ByteString.copyFrom("str-input".getBytes))
        .build()
      val bytesFeature = Feature.newBuilder().setBytesList(bytesList).build()
      assert(
        deserializer
          .bytesListFeature2SeqArrayByte(bytesFeature)
          .head === "str-input".getBytes.deep
      )
    ...
    "Test bytesListFeature2SeqString" in {
      val bytesList = BytesList
        .newBuilder()
        .addValue(ByteString.copyFrom("alice".getBytes))
        .addValue(ByteString.copyFrom("bob".getBytes))
        .build()
      val bytesFeature = Feature.newBuilder().setBytesList(bytesList).build()
      assert(
        deserializer
          .bytesListFeature2SeqString(bytesFeature) === Seq("alice", "bob")
      )
